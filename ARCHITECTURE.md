...
- `backend/lib/bot_engine.py` — strategy scanning, timing, order sizing, and execution state machine
...
- `frontend/src/components/bot/AddStrategyDialog.tsx` — user strategy values from the web UI
